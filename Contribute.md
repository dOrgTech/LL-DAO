# How to contribute to the LL-DAO Portal
...
The following is a set of guidelines for contributing to the LL-DAO Portal website and its educational content. 
These are mostly guidelines, not rules. 
Use your best judgment, and feel free to propose changes to this document in a pull request.

## Code of Conduct

This project and everyone participating in it is governed by the [Code of Conduct](https://github.com/dOrgTech/LL-DAO/blob/master/Code-of-Conduct.md). By participating, you are expected to uphold this code. 
...
* [Good first issue](https://github.com/dOrgTech/LL-DAO/issues/4) - issues which should only require a few lines of code, and a test or two.
* [Help wanted issues](https://github.com/dOrgTech/LL-DAO/issues/1) - issues which should be a bit more involved than `good-first-issue` issues.
